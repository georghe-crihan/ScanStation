...
#define IOCTLGetDeviceIds CTL_CODE(0x8000,0x803,METHOD_BUFFERED,FILE_ANY_ACCESS)
 0x80002018 = Get device ids: idVendor, idProduct, bcdDevice
 0x80002020 = Get descriptor from device: idVendor, idProduct, bcdDevice
 0x80002014 = Get packet sizes for pipes 
 0x80002008 = Do IO on Pipe1 (Control?) with SystemBuffer, size=MaximumPacketSize
